...
<table class="table table-striped  table-responsive" id="apuestas-table">
    ...
    <tr>
        ...
        <td>
            @if($fasesgrupo->estado == 0)
                <label class="label label-success">Por Jugar</label>
            @elseif($fasesgrupo->estado == 1)
                <label class="label label-default">Finalizado</label>
            @elseif($fasesgrupo->estado == 2)
                <label class="label label-warning">Cerrado</label>
            @else
                <label class="label label-default">Pasado</label>
            @endif
        </td>

...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Pronostico 2018 </b>MC</a>
    </div>
    ...
    <div class="register-box-body">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> Aceptar los <a target="_blank" href="https://pastebin.com/raw/sU7pw5rZ">Terminos</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('/login') }}" class="text-center">Ya tengo Usuario</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
